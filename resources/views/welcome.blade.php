...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  <head>
    ...
    <style>
      .fakeimg { height: 200%; background: #aaa; }
      .jumbotron { 
        background-image: url("img/port.jpg"); 
        background-size: 100%;
      }
      img.icon { height: 25px; width: auto;}
      img.camiseta { height: 250px; width: auto; box-shadow: 4px 4px 5px grey;}
    </style>
      ...
      <nav class="navbar navbar-expand-sm bg-dark navbar-dark"> <!-- Removing navbar-expand-sm shows this as a collapsed menu -->
        ...
        <div class="collapse navbar-collapse" id="collapsibleNavbar">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item"><a class="nav-link" href="#"><img class="icon" src="ico/carro.png" class="img-responsive"></a></li>
          </ul>
        </div>  
      </nav>
